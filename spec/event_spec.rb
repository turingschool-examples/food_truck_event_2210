...
describe Event do
  ...
  describe '#food_trucks_that_sell_names' do
    it 'returns all trucks that sell specified item arg' do
      event = Event.new('South Pearl Street Farmers Market')
      food_truck1 = FoodTruck.new('Rocky Mountain Pies')
      item1 = Item.new({name: 'Peach Pie (Slice)', price: '$3.75'})
      ...
      expect(event.food_trucks_that_sell_names(item1)).to eq(["Rocky Mountain Pies", "Palisade Peach Shack"])
      expect(event.food_trucks_that_sell_names(item3)).to eq(['Ba-Nom-a-Nom'])
      expect(event.food_trucks_that_sell_names('')).to eq([])
    end
  end
  ...
  describe '#list_all_items_sold_names' do
    it 'lists all of the item\'s names sold at event' do
      event = Event.new('South Pearl Street Farmers Market')
      food_truck1 = FoodTruck.new('Rocky Mountain Pies')
      item1 = Item.new({name: 'Peach Pie (Slice)', price: '$3.75'})
      item2 = Item.new({name: 'Apple Pie (Slice)', price: '$2.50'})
      ...
      expect(event.list_all_items_sold_names).to eq(['Apple Pie (Slice)', 'Banana Nice Cream', 'Peach Pie (Slice)', 'Peach-Raspberry Nice Cream'])
    end
  end

  describe '#total_inventory' do
    it 'lists all of the items sold at event and their corresponding stats' do
      event = Event.new('South Pearl Street Farmers Market')
      food_truck1 = FoodTruck.new('Rocky Mountain Pies')
      item1 = Item.new({name: 'Peach Pie (Slice)', price: '$3.75'})
      item2 = Item.new({name: 'Apple Pie (Slice)', price: '$2.50'})

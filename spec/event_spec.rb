...
RSpec.describe Event do 
  ...
  it 'can return a hash of total inventory' do
    ...
    expected = {
      item1 => {trucks: [food_truck1, food_truck3], total_quantity: 100},
      item2 => {trucks: [food_truck1, food_truck3], total_quantity: 19},
      item3 => {trucks: [food_truck2], total_quantity: 25},
      item4 => {trucks: [food_truck2, food_truck3], total_inventory: 60}
    }
